...
export class ListaProductosComponent {
  ...
  constructor(){
    this.producto = new Producto("Crocs","https://www.quetglas.net/media/cache/big/https---clacclac-eu.s3.eu-west-1.amazonaws.com/697756/2022/10/697756_0_9e9403e45a18c7fe897f025217b756eb.jpg",80);
    this.productos = [
      new Producto(
        "Nike Air Jordan",
